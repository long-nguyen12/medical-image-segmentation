...
from .lib.axial_atten import AA_kernel, SEAttention, SCSEModule
from .lib.context_module import CFPModule
from .lib.cbam import CBAM

@SEGMENTORS.register_module()
class UniPolyp(nn.Module):
    def __init__(self,
                 backbone,
                 decode_head,
                 neck=None,
    ...
    def forward(self, x):
        ...
        aa_atten_3_o = decoder_2_ra.expand(-1, self.in_channels[3], -1, -1).mul(aa_atten_3)
        ...
        aa_atten_2_o = decoder_3_ra.expand(-1, self.in_channels[2], -1, -1).mul(aa_atten_2)
        ...
        aa_atten_1_o = decoder_4_ra.expand(-1, self.in_channels[1], -1, -1).mul(aa_atten_1)
        ...
        aa_atten_0_o = decoder_5_ra.expand(-1, self.in_channels[0], -1, -1).mul(aa_atten_0)
